...
Shader::Shader(const char* vertexPath, const char* fragmentPath) {
    ...
    // Assicurati che ifstream possa lanciare eccezioni
    ...
    try {
        ...
        // Leggi i buffer dei file negli stream
        ...
        std::cout << "ERRORE::SHADER::FILE_NON_LETTO_CORRETTAMENTE: " << e.what() << std::endl;
    }
    ...
    // Elimina gli shader originali (ora sono linkati nel programma e non servono più)
